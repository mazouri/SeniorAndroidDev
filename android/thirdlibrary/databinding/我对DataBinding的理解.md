...
##5.如果绑定数据？
DataBinding的布局文件是MVVM中的V，数据对象是M，可以是POJO，也可以是JavaBean。绑定数据
    属于ViewModel层。一般的步骤是这样的：
...
[DataBindingAdapter](https://github.com/markzhai/DataBindingAdapter)或者[RxRecyclerAdapter](https://github.com/ahmedrizwan/RxRecyclerAdapter)
